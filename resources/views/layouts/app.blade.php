          ...
          <form id="transactionForm" action="{{ route('transactions.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  id="amount"
                  name="amount"
                  class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-8 p-2.5"
                  placeholder="0.00"
                  required
                />
              </div>
            ...
            <div class="mb-4">
              ...
              <div class="flex items-center justify-center w-full">
                ...
                >
                  ...
                  >
                    <div
                      class="w-10 h-10 flex items-center justify-center mb-3 text-gray-400"
                    >
            ...
            <div class="flex justify-end space-x-3 mt-6">
              <button
                ...
                class="px-4 py-2 bg-gray-100 text-gray-700 rounded-button whitespace-nowrap !rounded-button"
              >
                Annuler
              </button>
              <button
                type="submit"
                class="px-4 py-2 bg-primary text-white rounded-button whitespace-nowrap !rounded-button"
              >
                Enregistrer
              </button>
            </div>
